...
/*    if (Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::SideBySide) {
	...
	if(Settings::values.I71_stereoscopy.GetValue()){
		if(
			...
			(framebuffer_y>=layout.bottom_screen.top)&&
			(framebuffer_y<layout.bottom_screen.bottom)&&(
				(
					(framebuffer_x>=(layout.bottom_screen.left-layout.I71_u32GetStereoWidth()))&&
					(framebuffer_x<(layout.bottom_screen.right-layout.I71_u32GetStereoWidth()))
				)||(
					(framebuffer_x >= (layout.bottom_screen.left+layout.I71_u32GetStereoWidth()))&&
					(framebuffer_x < (layout.bottom_screen.right+layout.I71_u32GetStereoWidth()))
				)
		...
		else if(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::CardboardVR)return (
			(framebuffer_y>=layout.bottom_screen.top)&&
			(framebuffer_y<layout.bottom_screen.bottom)&&(
				(
					(framebuffer_x>=layout.bottom_screen.left)&&
					...
					(framebuffer_x>=layout.cardboard.bottom_screen_right_eye+(layout.width/2))&&
					(framebuffer_x<layout.cardboard.bottom_screen_right_eye+layout.bottom_screen.GetWidth()+(layout.width/2))
				)
			)
		);
		else return (framebuffer_y >= layout.bottom_screen.top &&
                framebuffer_y < layout.bottom_screen.bottom &&
                framebuffer_x >= layout.bottom_screen.left &&
                framebuffer_x < layout.bottom_screen.right);
...
/*        if (Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::SideBySide)
		...
		if(Settings::values.I71_stereoscopy.GetValue()){
			if(
				(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Parallel)||
				(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Cross)
			)new_x-=framebuffer_layout.I71_u32GetStereoWidth()*2;
			else if(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::CardboardVR)new_x-=(framebuffer_layout.width/2)-(framebuffer_layout.cardboard.user_x_shift*2);
		}
    }
/*    if (Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::SideBySide) {
	...
	if(Settings::values.I71_stereoscopy.GetValue()){
		if(
			...
			new_x=std::max(new_x,framebuffer_layout.bottom_screen.left-framebuffer_layout.I71_u32GetStereoWidth());
			new_x=std::min(new_x,framebuffer_layout.bottom_screen.right-framebuffer_layout.I71_u32GetStereoWidth()-1);
		}
    } else {
...
/*        if (Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::SideBySide)
		...
		if(Settings::values.I71_stereoscopy.GetValue()){
			if(
				(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Parallel)||
				(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Cross)
			)framebuffer_x-=framebuffer_layout.I71_u32GetStereoWidth()*2;
			else if(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::CardboardVR)framebuffer_x-=(framebuffer_layout.width/2)-(framebuffer_layout.cardboard.user_x_shift*2);
		}
    }
...
/*    if (Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::SideBySide) {
	...
	if(Settings::values.I71_stereoscopy.GetValue()){
		if(
			(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Parallel)||
			(Settings::values.render_3d.GetValue()==Settings::StereoRenderOption::SideBySide_Cross)
		)touch_state->touch_x=static_cast<float>(
			framebuffer_x-(framebuffer_layout.bottom_screen.left-framebuffer_layout.I71_u32GetStereoWidth())
		)/(
