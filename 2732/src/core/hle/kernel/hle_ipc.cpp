...
bool					HLERequestContext::I71_steIsSerializable(
	const Kernel::WakeupCallback* const	cpccbksource
){
	const auto				cpccallback=dynamic_cast<const ThreadCallback*>(cpccbksource);

	return (cpccallback==NULL);
}
