...
private:
	...
	static void				I71_stSetFullscreenSize(QWidget* const cpqwthis);
	void					I71_Render_UpdatePauseState(const bool cepause);
	void					I71_Render_UpdateFullscreenState(void);
#ifdef __unix__
