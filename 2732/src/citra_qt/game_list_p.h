...
//                              &extension);
			const auto				i71_cstrname=Loader::I71_strGetTitle(data(FullPathRole).toString().toStdString().c_str());
...
//                {UISettings::GameListText::FileName, QString::fromStdString(filename + extension)},
                {UISettings::GameListText::FileName, QString::fromStdString(i71_cstrname)},
