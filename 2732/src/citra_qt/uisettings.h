...
constexpr int			I71_cinUIFontPointDefault=16;
...
struct Values {
	...
	Settings::Setting<bool>	I71_enable_network{false, "EnableNetwork"};
	Settings::Setting<bool>	I71_enable_rom_caching{false, "EnableROMCaching"};
	QString					I71_qstrUIFontFamily;
	int						I71_inUIFontPoint;
	int						I71_inDesktopFPS;
	...
	u16						I71_u16iGameListSelectedGroup;
	u16						I71_u16iGameListSelectedItem;
