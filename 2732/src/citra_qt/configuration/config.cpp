...
extern void				I71_UpdateSettings(void);
...
//     {QStringLiteral("Fullscreen"),               QStringLiteral("Main Window"), {QStringLiteral("F11"),    Qt::WindowShortcut}},
	{QStringLiteral("Toggle Fullscreen"),QStringLiteral("Main Window"),{QStringLiteral("Alt+Enter"),Qt::WindowShortcut}},
...
//    ReadGlobalSetting(Settings::values.volume);
	ReadGlobalSetting(Settings::values.I71_volume);
    ...
    if (global) {
		...
		ReadBasicSetting(Settings::values.enable_audio_stretching);
		ReadBasicSetting(Settings::values.I71_ballance_front);
		ReadBasicSetting(Settings::values.I71_ballance_center);
		ReadBasicSetting(Settings::values.I71_ballance_side);
		ReadBasicSetting(Settings::values.I71_ballance_back);
    }
...
void Config::ReadLayoutValues() {
    ...
    ReadGlobalSetting(Settings::values.I71_stereoscopy);
//    ReadGlobalSetting(Settings::values.render_3d);
    ...
    if (global) {
		ReadBasicSetting(Settings::values.render_3d);
...
void Config::ReadUIValues() {
    ...
    if (global) {
		...
		ReadBasicSetting(UISettings::values.I71_enable_network);
		ReadBasicSetting(UISettings::values.I71_enable_rom_caching);
		UISettings::values.I71_qstrUIFontFamily=ReadSetting(QStringLiteral("UIFontFamily")).toString();
		UISettings::values.I71_inUIFontPoint=ReadSetting(QStringLiteral("UIFontPoint")).toInt();
		if(UISettings::values.I71_inUIFontPoint==0)UISettings::values.I71_inUIFontPoint=UISettings::I71_cinUIFontPointDefault;
		UISettings::values.I71_inDesktopFPS=ReadSetting(QStringLiteral("DesktopFPS")).toInt();
    }
...
void Config::ReadUIGameListValues() {
	...
	UISettings::values.I71_u16iGameListSelectedGroup=u16(ReadSetting(QStringLiteral("selectedgroup")).toInt());
	UISettings::values.I71_u16iGameListSelectedItem=u16(ReadSetting(QStringLiteral("selecteditem")).toInt());
...
//    WriteGlobalSetting(Settings::values.volume);
	WriteGlobalSetting(Settings::values.I71_volume);
    ...
    if (global) {
		...
		WriteBasicSetting(Settings::values.enable_audio_stretching);
		WriteBasicSetting(Settings::values.I71_ballance_front);
		WriteBasicSetting(Settings::values.I71_ballance_center);
		WriteBasicSetting(Settings::values.I71_ballance_side);
		WriteBasicSetting(Settings::values.I71_ballance_back);
    }
...
void Config::SaveLayoutValues() {
    ...
    WriteGlobalSetting(Settings::values.I71_stereoscopy);
//    WriteGlobalSetting(Settings::values.render_3d);
    ...
    if (global) {
		WriteBasicSetting(Settings::values.render_3d);
...
void Config::SaveUIValues() {
    ...
    if (global) {
		...
		WriteBasicSetting(UISettings::values.I71_enable_network);
		WriteBasicSetting(UISettings::values.I71_enable_rom_caching);
		WriteSetting(QStringLiteral("UIFontFamily"),UISettings::values.I71_qstrUIFontFamily);
		WriteSetting(QStringLiteral("UIFontPoint"),UISettings::values.I71_inUIFontPoint);
		WriteSetting(QStringLiteral("DesktopFPS"),UISettings::values.I71_inDesktopFPS);
    }
...
void Config::SaveUIGameListValues() {
	...
	WriteSetting(QStringLiteral("selecteditem"),UISettings::values.I71_u16iGameListSelectedItem);
	WriteSetting(QStringLiteral("selectedgroup"),UISettings::values.I71_u16iGameListSelectedGroup);
