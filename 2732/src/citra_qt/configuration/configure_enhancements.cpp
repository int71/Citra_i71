...
ConfigureEnhancements::ConfigureEnhancements(QWidget* parent)
	...
	ui->I71_toggle_stereoscopy->setEnabled(true);
...
void ConfigureEnhancements::SetConfiguration() {
	...
	ui->I71_toggle_stereoscopy->setChecked(Settings::values.I71_stereoscopy.GetValue());
...
void ConfigureEnhancements::ApplyConfiguration() {
	...
	Settings::values.I71_stereoscopy=ui->I71_toggle_stereoscopy->isChecked();
...
//        static_cast<Settings::MonoRenderOption>(ui->mono_rendering_eye->currentIndex());
    ...
    } else if (Settings::values.I71_stereoscopy.GetValue()==false/*Settings::values.render_3d.GetValue() == Settings::StereoRenderOption::Off*/) {
