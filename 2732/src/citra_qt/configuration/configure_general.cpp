...
void ConfigureGeneral::SetConfiguration() {
    if (Settings::IsConfiguringGlobal()) {
		...
		ui->I71_toggle_enable_network->setChecked(UISettings::values.I71_enable_network.GetValue());
		ui->I71_toggle_enable_rom_caching->setChecked(UISettings::values.I71_enable_rom_caching.GetValue());
...
void ConfigureGeneral::ApplyConfiguration() {
    ...
    if (Settings::IsConfiguringGlobal()) {
		...
		UISettings::values.I71_enable_network = ui->I71_toggle_enable_network->isChecked();
		UISettings::values.I71_enable_rom_caching = ui->I71_toggle_enable_rom_caching->isChecked();
