...
//    void SetVolumeIndicatorText(int percentage);
	void					I71_SetVolumeIndicatorText(int indb);
	void					I71_SetBallanceFrontIndicatorText(int indb);
	void					I71_SetBallanceCenterIndicatorText(int indb);
	void					I71_SetBallanceSideIndicatorText(int indb);
	void					I71_SetBallanceBackIndicatorText(int indb);
