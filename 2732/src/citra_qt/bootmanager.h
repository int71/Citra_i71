...
public slots:
	...
	void					I71_UpdatePauseState(const bool cepause);
	inline bool				I71_eIsPaused(void)const{
		return I71_ePaused;
	}
...
private:
    ...
    bool LoadOpenGL();
	void					paintEvent(QPaintEvent* const cpqpeevent)override final;
