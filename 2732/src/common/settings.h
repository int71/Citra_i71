...
struct Values {
	...
	SwitchableSetting<bool>	I71_stereoscopy{false, "stereoscopy"};
//    SwitchableSetting<StereoRenderOption> render_3d{StereoRenderOption::Off, "render_3d"};
	Setting<StereoRenderOption> render_3d{StereoRenderOption::SideBySide_Parallel,"render_3d"};
...
//    SwitchableSetting<AudioEmulation> audio_emulation{AudioEmulation::HLE, "audio_emulation"};
	Setting<AudioEmulation>	audio_emulation{AudioEmulation::HLE, "audio_emulation"};
...
//    SwitchableSetting<float, true> volume{1.f, 0.f, 1.f, "volume"};
	SwitchableSetting<int,true>	I71_volume{0,-50,0, "volume"};
	Setting<int,true>		I71_ballance_front{0,-50,0, "ballance_front"};
	Setting<int,true>		I71_ballance_center{0,-50,0, "ballance_center"};
	Setting<int,true>		I71_ballance_side{0,-50,0, "ballance_side"};
	Setting<int,true>		I71_ballance_back{0,-50,0, "ballance_back"};
