...
void RendererOpenGL::DrawTopScreen(const Layout::FramebufferLayout& layout,
	...
	if(Settings::values.I71_stereoscopy.GetValue()==false)DrawSingleScreen(screen_infos[0],
		top_screen_left,
		top_screen_top,
		top_screen_width,
		top_screen_height,
...
void RendererOpenGL::DrawBottomScreen(const Layout::FramebufferLayout& layout,
	...
	if(Settings::values.I71_stereoscopy.GetValue()==false)DrawSingleScreen(screen_infos[2],
		bottom_screen_left,
		bottom_screen_top,
		bottom_screen_width,
...
/*    case Settings::StereoRenderOption::Off: {
	...
	case Settings::StereoRenderOption::SideBySide_Cross:
		...
		glUniform1i(uniform_layer,1);
		DrawSingleScreen(screen_infos[2],
			(float)(int(bottom_screen.left)+int(layout.I71_u32GetStereoWidth())),
			bottom_screen_top,
			bottom_screen_width,
			bottom_screen_height,
			orientation
