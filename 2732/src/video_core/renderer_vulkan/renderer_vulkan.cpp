...
void RendererVulkan::DrawTopScreen(const Layout::FramebufferLayout& layout,
	...
	if(Settings::values.I71_stereoscopy.GetValue()==false)DrawSingleScreen(0,
		top_screen_left,top_screen_top,top_screen_width,top_screen_height,orientation
	);
	else
...
/*    case Settings::StereoRenderOption::Off: {
	...
	case Settings::StereoRenderOption::SideBySide_Parallel:
		DrawSingleScreen(1,
			(float)(int(top_screen_left)+int(layout.I71_u32GetStereoWidth())),
		...
		break;
	case Settings::StereoRenderOption::SideBySide_Cross:
		DrawSingleScreen(0,
			(float)(int(top_screen_left)+int(layout.I71_u32GetStereoWidth())),
			top_screen_top,top_screen_width,top_screen_height,orientation
		);
...
void RendererVulkan::DrawBottomScreen(const Layout::FramebufferLayout& layout,
	...
	if(Settings::values.I71_stereoscopy.GetValue()==false)DrawSingleScreen(2,
		bottom_screen_left,bottom_screen_top,bottom_screen_width,bottom_screen_height,orientation
	);
	else
    switch (Settings::values.render_3d.GetValue()) {
/*    case Settings::StereoRenderOption::Off: {
	...
	case Settings::StereoRenderOption::SideBySide_Cross:
		DrawSingleScreen(2,
			(float)(int(bottom_screen_left)-int(layout.I71_u32GetStereoWidth())),
