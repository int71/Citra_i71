...
SDL_JoystickOpen(int device_index)
{
    ...
    if (joystick->naxes > 0) {
		...
		joystick->I71_psi16SnapshotAxis=(Sint16*)SDL_calloc(joystick->naxes,sizeof(Sint16));
    }
    if (joystick->nhats > 0) {
        joystick->hats = (Uint8 *) SDL_calloc(joystick->nhats, sizeof(Uint8));
		joystick->I71_pui8SnapshotHat=(Uint8*)SDL_calloc(joystick->nhats,sizeof(Uint8));
    }
    ...
    if (joystick->nbuttons > 0) {
		...
		joystick->I71_pui8SnapshotButton=(Uint8*)SDL_calloc(joystick->nbuttons,sizeof(Uint8));
    }
...
SDL_JoystickClose(SDL_Joystick *joystick)
{
	...
	SDL_free(joystick->I71_psi16SnapshotAxis);
	SDL_free(joystick->I71_pui8SnapshotButton);
	SDL_free(joystick->I71_pui8SnapshotHat);
    SDL_free(joystick);
